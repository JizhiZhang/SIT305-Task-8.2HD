...
public class ChatActivity extends AppCompatActivity {
    ...
    private com.example.imagepro.ChatAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new com.example.imagepro.ChatAdapter(messageArrayList);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, final int position) {
                com.example.imagepro.Message audioMessage = (com.example.imagepro.Message) messageArrayList.get(position);
    ...
    private void sendMessage() {
        ...
        if (!this.initialRequest) {
            com.example.imagepro.Message inputMessage = new com.example.imagepro.Message();
                ...
                try {
                    ...
                    if (response != null &&
                        ...
                        for (RuntimeResponseGeneric r : responses) {
                            com.example.imagepro.Message outMessage;
                            switch (r.responseType()) {
                                case "text":
                                    outMessage = new com.example.imagepro.Message();
                                ...
                                case "image":
                                    outMessage = new com.example.imagepro.Message(r);
                                    messageArrayList.add(outMessage);
